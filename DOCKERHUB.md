...
You can also use `:latest` instead of a specific version tag (currently v0.27.0). Available tags are listed on the [Docker Hub tags page](https://hub.docker.com/r/iksnerd/council-hub/tags).
