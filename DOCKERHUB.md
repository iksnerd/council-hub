...
Warp discovers all 31 tools automatically from the MCP schema.
...
`:latest` always points at the newest release. To pin a specific version for reproducible deploys, swap it for a tag like `:v0.38.0` — the full list is on the [Docker Hub tags page](https://hub.docker.com/r/iksnerd/council-hub/tags).
