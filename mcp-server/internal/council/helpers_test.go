...
func mustPost(t *testing.T, s *Server, roomID, author, content string) int64 {
	t.Helper()
...
func mustPostTyped(t *testing.T, s *Server, roomID, author, content, msgType string) int64 {
	t.Helper()
...
func mustPostReply(t *testing.T, s *Server, roomID, author, content string, replyTo int64) int64 {
	t.Helper()
